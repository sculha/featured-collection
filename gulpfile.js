...
function copyHTML(cb) {
    gulp.src("src/*.html").pipe(gulp.dest("dist/fonts"));
    cb();
}
...
function cssLib(cb) {
    gulp.src([
        'src/assets/lib/owlcarousel/css/owl.carousel.min.css', 
        'src/assets/lib/owlcarousel/css/owl.theme.default.min.css'
    ])
        .pipe(autoprefixer({
            browserlist: ['last 2 versions'],
            cascade: false
...
function watch_files() {
    ...
    gulp.watch("src/assets/fonts/**/*.*", copyFont);
    gulp.watch("src/assets/sass/**/*.scss", css);
    gulp.watch("src/assets/lib/**/**/*.css", cssLib);
    gulp.watch("src/assets/lib/**/*.js", jsLib);
...
exports.default = series(nunjucks, css, cssLib, js, jsLib, imageMin, copyFont, watch_files);

// 'gulp build' will build all assets but not run on a local server.
exports.build = parallel(nunjucksMinify, css, cssLib, js, jsLib, copyFont, imageMin);
